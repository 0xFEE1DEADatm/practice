...
namespace PracticeCLR {
	...
	/// <summary>
	/// Сводка для SecondDynamicForm
	/// </summary>
	public ref class SecondDynamicForm : public System::Windows::Forms::Form
	{
	private:
	...
	private: System::Windows::Forms::Button^ showSecondDynamicBtn;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->showSecondDynamicBtn = (gcnew System::Windows::Forms::Button());
			this->SuspendLayout();
			// 
			...
			this->authorLabel->Size = System::Drawing::Size(376, 17);
			this->authorLabel->TabIndex = 2;
			this->authorLabel->Text = L"Динамическая цепочка 2 (Сортировка по баллу)";
			// 
			...
			// 
			// showSecondDynamicBtn
			// 
			this->showSecondDynamicBtn->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
			this->showSecondDynamicBtn->Location = System::Drawing::Point(476, 326);
			this->showSecondDynamicBtn->Name = L"showSecondDynamicBtn";
			this->showSecondDynamicBtn->Size = System::Drawing::Size(80, 36);
			this->showSecondDynamicBtn->TabIndex = 13;
			this->showSecondDynamicBtn->Text = L"Показать цепочку";
			this->showSecondDynamicBtn->UseVisualStyleBackColor = true;
			this->showSecondDynamicBtn->Click += gcnew System::EventHandler(this, &SecondDynamicForm::showSecondDynamicBtn_Click);
			// 
			// SecondDynamicForm
			// 
			...
			this->Controls->Add(this->showSecondDynamicBtn);
			...
			this->Name = L"SecondDynamicForm";
			this->Text = L"SecondDynamicForm";
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void showSecondDynamicBtn_Click(System::Object^ sender, System::EventArgs^ e) {
		if (fileName != nullptr)
		{
