...
namespace PracticeCLR {
	...
	/// </summary>
	public ref class SearchTreeForm : public System::Windows::Forms::Form
	{
	private:
	...
	private: System::Windows::Forms::Button^ showSearchTreeBtn;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->showSearchTreeBtn = (gcnew System::Windows::Forms::Button());
			this->SuspendLayout();
			// 
			// searchTreeLabel
			// 
			...
			this->searchTreeLabel->Location = System::Drawing::Point(172, 9);
			this->searchTreeLabel->Name = L"searchTreeLabel";
			this->searchTreeLabel->Size = System::Drawing::Size(198, 29);
			this->searchTreeLabel->TabIndex = 0;
			this->searchTreeLabel->Text = L"Дерево поиска";
			// 
			...
			// showSearchTreeBtn
			// 
			this->showSearchTreeBtn->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->showSearchTreeBtn->Location = System::Drawing::Point(454, 323);
			this->showSearchTreeBtn->Name = L"showSearchTreeBtn";
			this->showSearchTreeBtn->Size = System::Drawing::Size(111, 49);
			this->showSearchTreeBtn->TabIndex = 13;
			this->showSearchTreeBtn->Text = L"Показать дерево";
			this->showSearchTreeBtn->UseVisualStyleBackColor = true;
			this->showSearchTreeBtn->Click += gcnew System::EventHandler(this, &SearchTreeForm::showSearchTreeBtn_Click);
			// 
			// SearchTreeForm
			// 
			...
			this->Controls->Add(this->showSearchTreeBtn);
			...
			this->Name = L"SearchTreeForm";
			this->Text = L"SearchTreeForm";
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void showSearchTreeBtn_Click(System::Object^ sender, System::EventArgs^ e) {
		if (fileName != nullptr)
		{
